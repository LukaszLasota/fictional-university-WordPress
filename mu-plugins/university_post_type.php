...
function university_post_types(){
    ...
    register_post_type('event', array(
        'capability_type'=>'event',//uprawnienia do edytowani w panelu dla stworzonego użytkownika
        'map_meta_cap' => true,//uprawnienia do edytowani w panelu dla stworzonego użytkownika
        'show_in_rest' => true,
