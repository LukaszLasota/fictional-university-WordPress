...
function university_files(){
    wp_enqueue_script( 'google-map', '//maps.googleapis.com/maps/api/js?key=AIzaSyDg1Gq9YCA59TaeZryciThRIek5ZKfgYPY', NULL, '1.0', true);
    
    // wp_enqueue_script( 'main-university-js', get_theme_file_uri( '/js/scripts-noWebpack.js' ), array('jquery'), '1.0', true); // dodanie pliku js, nazwa, link, zaleznosć, wersja, czy ma byc w footer czy nie (moze byc w head) dodano array(jquery) poprzedni skrypt script-bundle.js
    ...
    // wp_enqueue_style('university_main_styles', get_stylesheet_uri()); //dodanie pliku css
    ...
    wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.433fed3878d7afa5b900.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.433fed3878d7afa5b900.css'));
...
function university_features(){
    // register_nav_menu( 'headerMenuLocation', 'Header Menu Location'); dodanie menu w różnych miejscach
...
function universityMapKey($api){
    $api['key'] = 'AIzaSyDg1Gq9YCA59TaeZryciThRIek5ZKfgYPY';
    return $api;
}
